...
function encrypt($retorno){
    //sha 512  criptografiaendtoendhorusdistribuidora
      
    $mystring = "8dc935afb1110895324adf8f460c4797ea44b7c4607da9db281b47a0581d476a0475a1fe2d81087ed181edc2a7d254b7a726c814bb00ab79cbcc3562004041b7";
	  $cipher_method = 'aes-128-ctr';
		$enc_key = openssl_digest(php_uname(), 'SHA256', TRUE);  
		$enc_iv = openssl_random_pseudo_bytes(openssl_cipher_iv_length($cipher_method));  
		$crypted_token = openssl_encrypt($retorno, $cipher_method, $enc_key, 0, $enc_iv) . "::" . bin2hex($enc_iv);
	
	  return $crypted_token.$mystring;
	
}

function decrypt($retorno){
  $mystring = "8dc935afb1110895324adf8f460c4797ea44b7c4607da9db281b47a0581d476a0475a1fe2d81087ed181edc2a7d254b7a726c814bb00ab79cbcc3562004041b7";
  $val = $retorno.$mystring;
  $valor = substr($val, 0, -128);
