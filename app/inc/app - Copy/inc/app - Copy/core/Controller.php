...
{   
       ...
       public function dbSantri()
    {
        ...
        define("MYDB","(DESCRIPTION=(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = 200.252.18.140)(PORT = 1521)))(CONNECT_DATA=(SERVICE_NAME = SANTRIPDB)))");
        // Connect to database      
    ...
    {      
        $mysqli = new mysqli("localhost", "usuario_dev_solar","!YnG;uGHT^ct{!6","banco_dev_solar"); 
        $mysqli->set_charset('utf8mb4');
