 ...
 *
 */
class NcmsModel extends DataList
{
	/**
	 * Initialize
	 */
	...
	{
		$this->setQuery(DB::table(TABLE_PREFIX.TABLE_NCM));
	}
    ...
    public function search($search_query)
    {
        ...
        foreach ($search_strings as $sq) {
            ...
            $query->where(function($q) use($sq) {
                $q->where(TABLE_PREFIX.TABLE_NCM.".cod_ncm", "LIKE", $sq."%");
            });
        }
