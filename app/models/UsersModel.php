        ...
        foreach ($search_strings as $sq) {
            ...
            $query->where(function($q) use($sq) {
                ...
                $q->orWhere(TABLE_PREFIX.TABLE_USERS.".firstname", "LIKE", "%". $sq."%");
								$q->orWhere(TABLE_PREFIX.TABLE_USERS.".account_type", "LIKE", "%". $sq."%");
								$q->orWhere(TABLE_PREFIX.TABLE_USERS.".office", "LIKE", "%". $sq."%");
                $q->orWhere(TABLE_PREFIX.TABLE_USERS.".cpf/cnpj", "LIKE", $sq."%");                
            });
        }
