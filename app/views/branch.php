...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Filiais - ". site_settings("site_name")) ?></title>
    ...
    <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Filiais");
            $TopBar->btn = array(
                "icon" => "mdi mdi-source-branch",
                "title" => __("Adicionar Filiais"),
                "link" => APPURL."/branchs/new"
            );
            require_once(APPPATH.'/views/fragments/topbar.fragment.php');
        ?>

        <?php require_once(APPPATH.'/views/fragments/branch.fragment.php'); ?>
