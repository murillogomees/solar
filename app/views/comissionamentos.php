...
<html lang="pt-BR">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/responsive/2.4.0/css/responsive.dataTables.min.css">
				<title><?=__("Comissionamentos - ". site_settings("site_name")) ?></title>
     </head>
      <style>.lineTitle {
      font-weight: 300;
      font-size: 20px;
  ...
  <body>
      ...
      $TopBar->title=__("Comissionamentos");

      require_once(APPPATH.'/views/fragments/topbar.fragment.php');
      ?><?php require_once(APPPATH.'/views/fragments/comissionamentos.fragment.php');
