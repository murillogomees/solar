            ...
            <div class="clearfix">
                <aside class="skeleton-aside hide-on-medium-and-down">
                    ...
                    <div class="js-search-results">
                        ...
                        <div class="loadmore pt-20 none">
                            <a class="fluid button button--light-outline js-loadmore-btn js-autoloadmore-btn" data-loadmore-id="1" href="<?= APPURL."/garantias?aid=".$User->get("id")."&q=".urlencode(Input::get("q")) ?>">
                ...
                <section class="skeleton-content">
                    <form class="js-ajax-form"
                          action="<?= APPURL."/garantias/".($User->isAvailable() ? $User->get("id") : "new") ?>"
                          method="POST">
                        ...
                        <?php
                            if(null !== $User->get("id")){
                                if($User->get("is_active")){
                                  $titulo = "Prazo de Garantia: <label style=\"color:#51524f;\">" . htmlchars($User->get("name")) . "</label>";
                                }else{
                                  $titulo = "Prazo de Garantia: <label style=\"color:red;\">" . htmlchars($User->get("name")) .  "</label>";
                                }
                            } else {
                                $titulo = "Cadastro de Prazo de Garantia";
                            }
                        ?>
                              ...
                              <div class="col s6 m6 l4">
                                 <label class="form-label">
                                              ...
                                              <span class="tooltip tippy"
                                                    data-position="top"
                                                    data-size="small"
                                                    title="<?= __("Determina o nome para o Prazo de Garantia.") ?>">
