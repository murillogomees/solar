        <div class="skeleton skeleton--full" id="users">
            <div class="clearfix">
                                    ...
                                    <div style="background-color: #fff;" class="aside-list-item js-list-item <?= $active_item_id == $u->get("id") ? "active" : "" ?>">
                                        <div class="clearfix">
                                            ...
                                            <?php if ($AuthUser->canEdit($u)): ?>
                                                ...
                                                <a class="full-link js-ajaxload-content" href="<?= APPURL."/garantias/".$u->get("id") ?>"></a>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                ...
                <section class="skeleton-content hide-on-medium-and-down">
                    <div class="no-data">
                        <span class="no-data-icon sli sli-hourglass"></span>
                        <p><?= __("Selecione uma Condição de Pagamento na lista ao lado para ver os detalhes ou cadastre uma nova no botão acima da lista.") ?></p>
                    </div>
                </section>
            </div>
        </div>
