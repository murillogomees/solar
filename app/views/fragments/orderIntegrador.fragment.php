        ...
        <div class="section-content">
          <div class="form-result"></div>   
            ...
            <div  class="clearfix mb-20">
              <div  class="col s12 m12 m-last l2 mb-20">
                ...
                <select  class="input js-required select2 status calcPrice" data-type="status" name="status">
              ...
              <div class="col s6 s-last m6 m-last l2">
                ...
                <div class="col s12 m8 l2 mb-20 l-last">
                <label class="form-label">
                                                  <span class="compulsory-field-indicator">*</span>
                                                  <?= __("Uso e Consumo:") ?>
                                                  <span class="tooltip tippy"
...
<!--                   <div class="col s12 m6 l2 l-last mb-20">
            ...
            <div class="clearfix mb-20">
              <div class="col s12 m4 l2 mb-20">
                ...
                <select onchange="autosave()" id="selectkitprod" class="autosave input select2 changeKit producerKit selectProducerKit typeOrderKit" name="producer_kit">
             ...
             <div id="div_tensao" class="col s12 m4 l2 mb-20" hidden>
                ...
                <select  onchange="autosave()" id="tensao" class=" autosave input select2  changeFase " name="tensao">
               ...
               <div id="div_consumo" class="col s12 m4 l2 mb-20" hidden>
                <label class="form-label">
                                                  <span class="compulsory-field-indicator">*</span>
                                                  <?= __("Medir Consumo:") ?>
                                                  <span class="tooltip tippy"
                ...
                <select  onchange="autosave()" id="medir" class="autosave input select2   changeTC" name="medir">
              ...
              <div id="div_cc" class="col s12 m4 l2 l-last mb-20" hidden>
                <label class="form-label">
                                                  <span class="compulsory-field-indicator">*</span>
                                                  <?= __("Considerar cabos e conectores Enphase?") ?>
                                                  <span class="tooltip tippy"
                                                        data-position="top"
                                                        data-size="small"
                ...
                <select  onchange="autosave()" id="medir_cc" class="autosave input select2   changeConsidera" name="medir_cc">
                                                 <option value="" selected disabled hidden>Selecione</option>                         
              ...
              <div id="div_fases" class="col s12 m4 l2 mb-20 " hidden>
                ...
                <select  onchange="autosave()" id="fases" class="autosave input select2  changeAcoplador" name="fases">
                                                 <option value="" selected disabled hidden>Selecione</option>                         
              ...
              <div class="col s12 m4 l2 mb-20">
                ...
                <select onchange="autosave()" id="selectkittipo" class="autosave input select2 changeKit model-select typeOrderKit" name="model_select">
            ...
            <div class="clearfix mb-20">
              <div class="col s12 m4 l2 mb-20">
                ...
                <select onchange="autosave()" id="filialOrigem" class="autosave input select2 uf-branch calcPrice typeOrderKit" name="branch_origin">
                                                 <option value="" selected disabled hidden>Filial de Origem</option>                                                                                                
                                                  <?php foreach($Branchs->getDataAs("Branch") as $k):?>
                                                    <option value="<?= $k->get("name") ?>" <?= $User->get("branch") == $k->get("name") ? "selected"  : "" ?> ><?= $k->get("name") ?></option>
                                                  <?php endforeach;?>                                                                                                  
                                              </select>
              </div>
                <div class="col s12 m4 l2 mb-20">
                ...
                <select onchange="autosave()" id="destinoFrete" class=" autosave input select2 ufFrete calcPrice typeOrderKit" name="destiny_frete">
                   <option value="" selected disabled hidden>Destino do Frete</option>                    
                    <?php foreach($Fretes->getDataAs("Shipp") as $k): ?>
                      <option value="<?= $k->get("id") ?>" <?= $User->get("uf_frete") == $k->get("id") ? "selected"  : "" ?>><?= $k->get("name") ?></option>
                    <?php endforeach;?>                                                                                                  
                </select>
              ...
              <div class="col s12 m4 l2 mb-20">
                ...
                <select onchange="autosave()" id="pagamento" class="autosave input select2 paymentMode calcPrice typeOrderKit" name="payment_select">
           ...
           <div class="clearfix mb-20">
             <div class="col s12 s-last m12 m-last l2 mb-20">
                <label class="form-label">
                                                  <span class="compulsory-field-indicator">*</span>
                                                  <?= __("Vendedor:") ?>
                                                  <span class="tooltip tippy"
                   ...
                   <select onchange="autosave()" id="vendedorS" class="autosave input select2 seller" name="vendedor">
             ...
             <div class="col s12 s-last m12 m-last l2 ">
                                           ...
                                           <select onchange="autosave()" class="autosave input select2 comissaoActive calcPrice" id="comissaoActive" name="comissao_active" > 
                                                 <option value="0" <?= $User->get("comissao_active") == "0" ? "selected" : "" ?> selected>Não</option> 
                                              <optgroup label="Sim">
                                                  <option value="1" <?= $User->get("comissao_active") == "1" ? "selected" : "" ?> ><?= __("Percentual (%)") ?></option>
                                                  <option value="2" <?= $User->get("comissao_active") == "2" ? "selected" : "" ?> ><?= __("Valor Cheio (R$)") ?></option>
                                                 </optgroup>                                                                                                  
                                            </select>
                                        </div>
               <div class="col s12 s-last m12 m-last l2 l-last">
                                            <label class="form-label">
                                                <span class="compulsory-field-indicator">*</span>
                                                <?= __("Comissão") ?>
                                                <span class="tooltip tippy"
                                            ...
                                            <input onchange="autosave()" id="comissao" class="autosave input js-required comissao calcPrice"
                                                   ...
                                                   value="<?= htmlchars($User->get("comissao")) ?>"                                                   
                                        </div>
            ...
            <div class="clearfix mb-20" style="border-bottom:solid 1px #cecece">
              <span class="form1-label" style="display: inline-block; margin-bottom: 5px; font-size: 15px;color: #2a3f54;font-weight: 500; line-height: 17px">Descrição da Proposta</span>
                 ...
                 <p class="pslide"> *Arraste para os lados para navegar na tabela.  <span class="mdi mdi-swap-horizontal" style="font-size:20px"></span> </p>  
            ...
            <div class="clearfix mb-20 table-responsive" style="overflow-x:auto;">
             ...
             <div class="col s12 s-last m12 m-last l2 comissaoLiquida" <?= $User->get("comissao_active") == 0 ? "hidden" : "" ?> <?= !$User->isAvailable() ? "hidden" : "" ?>>
                                            <label class="form-label">
                                            <?= __("Comissão líquida") ?>
                                            </label>

                                           <input onchange="autosave()" <?= $User->get("comissao_active") == 0 ? "hidden" : "" ?> <?= !$User->isAvailable() ? "hidden" : "" ?> class="input2 comissaoLiquida" value="<?= $ProdTotal[0]->margemLucro ?>"
                    maxlength="50" readonly>
                                                   
                                        </div>
           
               
               <div class="col s12 s-last m12 m-last l2" <?= $AuthUser->canEditOrder($AuthUser) ? "" : "hidden" ?>>
                                            
                                            <label class="form-label">
                                                <?= __("Margem") ?>
                                            </label>

                                           <input onchange="autosave()" <?= $AuthUser->canEditOrder($AuthUser) ? "" : "hidden type='hidden'" ?> class="input2 margemLucro" value="<?= $ProdTotal[0]->margemLucro ?>"
                    maxlength="50" readonly>
                 </div>
                  ...
                  <div class="col s12 s-last m12 m-last l2" <?= $AuthUser->canEditOrder($AuthUser) ? "" : "hidden" ?>>
                   ...
                   <input onchange="autosave()"  id="deconto" <?= $AuthUser->canEditOrder($AuthUser) ? "" : "hidden type='hidden'" ?> style="background-color:#fbfbfb" class="autosave input2 calcPrice desconto" value="<?= $ProdTotal[0]->desconto ?>"
maxlength="4">
                 </div>
              ...
              <table id="orderTable" border="1" class="ps-table table-responsive table table-hover display nowrap" style="margin-top:30px;">  
                <thead>
                  <tr>
                    <th>Produto</th>
                    <th>DataSheet</th>
                    <th>Quantidade <span   class="mdi mdi-autorenew calcPrice" data-type="renew" style="font-size:14px;cursor:pointer;"></span></th>
                    <th>Preço Unitário</th>                  
                    <th>Preço Total</th>
                    <th type="hidden" hidden>Preço Sem A</th>
                    <th type="hidden" hidden>Margem de Lucro</th>
                    <th style="color:#fff; width:10%">Ações</th>
                  </tr>
                  </thead>
                    ...
                    <?php $OrcamentoFeito = json_decode($User->get("products_order")); ?>                 
                      <?php foreach($OrcamentoFeito as $o): ?>
                        <?php $Produto = $this->InfoProduto($o->id); 
                              ...
                              $tipoProduto = preg_replace("/\s+/", "", $Produto->get("product_type"));?>                       
                        <tr id="<?= $tipoProduto ?>" data-type="<?= $tipoProduto ?>">                          
                          <td style="color:#000">
                            <select onchange="calcPrice()" onchange="autosave()" id="<?= $tipoProduto ?>" class="autosave select-table selectProduct calcPrice select3">
                          ...
                          <td type="hidden" hidden>
                            <input onchange="autosave()"  type="hidden" class="input-table-order row-total priceLiq" value="" readonly>
                          </td>                           
                          <td type="hidden" hidden>
                            <input  onchange="autosave()"  type="hidden" class="input-table-order row-total margemTotal" value="" readonly>
                          </td>                          
                          <td style="color:#000;">
                            <input type="text" class="input-table-order" value="" readonly>
                ...
                <tr>
                  ...
                  <td style="color:#000"></td>       
                  <td style="color:#000"><input onchange="autosave()"  id="vuntTotal" type="text" class="input-table-order row-total totalUnitField" value="<?php echo format_price($ProdTotal[0]->totalUnit) ?>" readonly></td>
                  <td style="color:#000"><input onchange="autosave()"  id="vtotalTotal" type="text" class="input-table-order row-total totalTotalField" value="<?php echo format_price($ProdTotal[0]->totalTotal) ?>" readonly></td>
                  <td type="hidden" hidden><input onchange="autosave()"  id="vtotalPriceSemJuros" type="hidden" class="input-table-order row-total vmargemTotal" value="<?= $ProdTotal[0]->semJuros ?>" readonly></td> 
                  <td type="hidden" hidden><input onchange="autosave()"  id="vmargemTotal" type="hidden" class="input-table-order row-total vmargemTotal" value="<?= $ProdTotal[0]->margemLucro ?>" readonly></td> 
                  <td style="color:#000;"></td>                  
                </tr>
                  </tfoot>
              </table>
