            ...
            <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="inner">
                                                ...
                                                <?php
                                                        ...
                                                        $cod_origin = $u->get("cod_origin");

                                                ?>

                                                <div class="sub"><b style="color: #506982">Código de Origem: </b><?= ucFirst($cod_origin)?></div>
                                                <div class="meta">
                                            ...
                                            <?php if ($AuthUser->canEdit($u)): ?>
                                                ...
                                                <a class="full-link js-ajaxload-content" href="<?= APPURL."/origins/".$u->get("id") ?>"></a>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                ...
                <section class="skeleton-content hide-on-medium-and-down">
                    <div class="no-data">
                        ...
                        <p><?= __("Selecione uma Origem na lista ao lado para visualizar os detalhes ou cadastre uma nova no botão acima da lista.") ?></p>
                    </div>
                </section>
            </div>
        </div>
