            ...
            <div class="clearfix">
                                    ...
                                    <div style="background-color: #fff;" class="aside-list-item js-list-item <?= $active_item_id == $u->get("id") ? "active" : "" ?>">
                                        <div class="clearfix">
                                            ...
                                            <?php if ($AuthUser->canEdit($u)): ?>
                                                ...
                                                <a class="full-link js-ajaxload-content" href="<?= APPURL."/producers/".$u->get("id") ?>"></a>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                ...
                <section class="skeleton-content hide-on-medium-and-down">
                    <div class="no-data">
                        ...
                        <p><?= __("Selecione um Fabricante na lista ao lado para ver os detalhes ou cadastre um novo no botão acima da lista.") ?></p>
                    </div>
                </section>
            </div>
        </div>
