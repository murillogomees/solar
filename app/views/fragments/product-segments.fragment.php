        <div class="skeleton skeleton--full" id="product-segments">
            <div class="clearfix">
                <aside class="skeleton-aside">
                    ...
                    <div class="js-search-results">
                        <?php if ($ProdSegments->getTotalCount() > 0): ?>
                                    ...
                                    <div style="background-color: #fff;" class="aside-list-item js-list-item <?= $active_item_id == $u->get("id") ? "active" : "" ?>">
                                        <div class="clearfix">
                                            ...
                                            <div class="inner">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   data-id="<?= $u->get("id") ?>"
                                                                   data-url="<?= APPURL."/product-segments" ?>">
                                                                    <?= __("Delete") ?>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <a class="full-link" href="<?= APPURL."/product-segments/".$u->get("id") ?>"></a>
                            ...
                            <?php if($ProdSegments->getPage() < $ProdSegments->getPageCount()): ?>
                                <div class="loadmore mt-20">
                                    ...
                                    ?>
                                    <center>
                                      <a class="fluid button " data-loadmore-id="1" href="<?= $url.($ProdSegments->getPage()+1) ?>">
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if ($ProdSegments->searchPerformed()): ?>
