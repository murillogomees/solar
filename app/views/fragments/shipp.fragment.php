            ...
            <div class="clearfix">
                <aside class="skeleton-aside hide-on-medium-and-down">
                    ...
                    <div class="js-search-results">
                        ...
                        <div class="loadmore pt-20 none">
                            <a class="fluid button button--light-outline js-loadmore-btn js-autoloadmore-btn" data-loadmore-id="1" href="<?= APPURL."/shipping?aid=".$User->get("id")."&q=".urlencode(Input::get("q")) ?>">
                ...
                <section class="skeleton-content">
                    <form class="js-ajax-form"
                          action="<?= APPURL."/shipping/".($User->isAvailable() ? $User->get("id") : "new") ?>"
                          method="POST">
                        ...
                        <?php
                            if(null !== $User->get("id")){
                                if($User->get("is_active")){
                                  $titulo = "Frete: <label style=\"color:green;\">" . htmlchars($User->get("name")) . "</label>";
                                }else{
                                  $titulo = "Frete: <label style=\"color:red;\">" . htmlchars($User->get("name")) .  "</label>";
                                }
                            } else {
                                $titulo = "Cadastro de Frete";
                            }
                        ?>
                              ...
                              <div class="col s6 m6 l4">
                                 <label class="form-label">
                                   ...
                                   <span class="tooltip tippy"
                                        data-position="top"
                                        data-size="small"
                                        title="<?= __("Determina se o frete cadastrado estará Ativado/Desativado.") ?>">
                                        ...
                                        <div class="col s12 m12 l4 l-last">
                                          <label class="form-label">
                                              ...
                                              <span class="tooltip tippy"
                                                    data-position="top"
                                                    data-size="small"
                                                    title="<?= __("Digite o valor do frete.") ?>">
                                                    <span class="mdi mdi-help-circle" style="font-size:13px;"></span>
                                          </label>
                                          ...
                                          <input class="input js-required"
                                                 name="price_shipp"
                                                 type="text"
                                                 value="<?= htmlchars($User->get("price_shipp")) ?>"
                                                 maxlength="300">
                                        </div>
                                    </div>
