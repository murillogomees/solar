        <div class="skeleton skeleton--full" id="users">
            <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="inner">
                                                ...
                                                <?php
                                                        ...
                                                        $price_shipp = $u->get("price_shipp");

                                                ?>

                                                <div class="sub"><b style="color: #506982">Valor do frete: </b><?= ucFirst($price_shipp)?></div>
                                                <div class="meta">
                                            ...
                                            <?php if ($AuthUser->canEdit($u)): ?>
                                                ...
                                                <a class="full-link js-ajaxload-content" href="<?= APPURL."/shipping/".$u->get("id") ?>"></a>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                ...
                <section class="skeleton-content hide-on-medium-and-down">
                    <div class="no-data">
                        <span class="no-data-icon sli sli-map"></span>
                        <p><?= __("Selecione um Frete na lista ao lado para visualizar os detalhes ou cadastre uma nova no botão acima da lista.") ?></p>
                    </div>
                </section>
            </div>
        </div>
