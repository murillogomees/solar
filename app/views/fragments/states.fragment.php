        <div class="skeleton skeleton--full" id="states">
            <div class="clearfix">
                <aside class="skeleton-aside">
                    ...
                    <div class="js-search-results">
                        <?php if ($States->getTotalCount() > 0): ?>
                                    ...
                                    <div style="background-color: #fff;" class="aside-list-item js-list-item <?= $active_item_id == $u->get("id") ? "active" : "" ?>">
                                        <div class="clearfix">
                                            ...
                                            <div class="inner">
                                                ...
                                                <a class="full-link js-ajaxload-content" href="<?= APPURL."/states/".$u->get("id") ?>"></a>
                            ...
                            <?php if($States->getPage() < $States->getPageCount()): ?>
                                <div class="loadmore mt-20">
                                    ...
                                    ?>
                                  <center>
                                    <a class="fluid button" data-loadmore-id="1" href="<?= $url.($States->getPage()+1) ?>">
                ...
                <section class="skeleton-content hide-on-medium-and-down">
                    <div class="no-data">
                        <span class="no-data-icon sli sli-layers"></span>
                        <p><?= __("Selecione um Estado na lista ao lado para ver os detalhes ou cadastre um novo no botão acima da lista.") ?></p>
                    </div>
                </section>
            </div>
        </div>
