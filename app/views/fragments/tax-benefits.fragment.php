        <div class="skeleton skeleton--full" id="users">
            <div class="clearfix">
                                    ...
                                    <div style="background-color: #fff;" class="aside-list-item js-list-item <?= $active_item_id == $u->get("id") ? "active" : "" ?>">
                                        <div class="clearfix">
                                            ...
                                            <?php if ($AuthUser->canEdit($u)): ?>
                                                ...
                                                <a class="full-link" href="<?= APPURL."/benefits/".$u->get("id") ?>"></a>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                ...
                <section class="skeleton-content hide-on-medium-and-down">
                    <div class="no-data">
                        <span class="no-data-icon sli sli-organization"></span>
                        <p><?= __("Selecione um Benefício na lista ao lado para visualizar os detalhes ou cadastre um novo no botão acima da lista.") ?></p>
                    </div>
                </section>
            </div>
        </div>
