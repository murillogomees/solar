...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Prazo de Garantia do Produto - ". site_settings("site_name")) ?></title>
    </head>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Prazo de Garantia do Produto");
            $TopBar->btn = array(
                "icon" => "sli sli-hourglass",
                "title" => __("Adicionar Prazo de Garantia do Produto"),
                "link" => APPURL."/garantias/new"
        ...
        <?php require_once(APPPATH.'/views/fragments/garantias.fragment.php'); ?>
