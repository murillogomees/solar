...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Origem do Produto - ". site_settings("site_name")) ?></title>
    </head>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Origem do Produto");
            $TopBar->btn = array(
                "icon" => "sli sli-map",
                "title" => __("Adicionar Origem do Produto"),
                "link" => APPURL."/origins/new"
        ...
        <?php require_once(APPPATH.'/views/fragments/origins.fragment.php'); ?>
