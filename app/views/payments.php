...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Condição de pagamento - ". site_settings("site_name")) ?></title>
    </head>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Condição de Pagamento");
            $TopBar->btn = array(
                "icon" => "sli sli-credit-card",
                "title" => __("Adicionar Condição de Pagamento"),
                "link" => APPURL."/payments/new"
        ...
        <?php require_once(APPPATH.'/views/fragments/payments.fragment.php'); ?>
