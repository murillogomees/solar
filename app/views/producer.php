...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Fabricante - ". site_settings("site_name")) ?></title>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Fabricante");
            $TopBar->btn = array(
                "icon" => "sli sli-layers",
                "title" => __("Adicionar novo Fabricante"),
                "link" => APPURL."/producers/new"
        ...
        <?php require_once(APPPATH.'/views/fragments/producer.fragment.php'); ?>
