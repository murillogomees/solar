...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Kits do Produto - Horus Solar") ?></title>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Kits do Produto");
            $TopBar->btn = array(
                "icon" => "sli sli-directions",
                "title" => __("Adicionar Kit do Produto"),
        ...
        <?php require_once(APPPATH.'/views/fragments/product-kit.fragment.php'); ?>
