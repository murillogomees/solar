...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Modelo de Produto - ". site_settings("site_name")) ?></title>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Modelo de Produto");
            $TopBar->btn = array(
                "icon" => "sli sli-action-undo",
                "title" => __("Adicionar Modelo de Produto"),
                "link" => APPURL."/product-models/new"
        ...
        <?php require_once(APPPATH.'/views/fragments/product-model.fragment.php'); ?>
