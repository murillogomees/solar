...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Tipo do Produto - ". site_settings("site_name")) ?></title>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Tipo do Produto");
            $TopBar->btn = array(
                "icon" => "sli sli-wrench",
                "title" => __("Adicionar Tipo do Produto"),
        ...
        <?php require_once(APPPATH.'/views/fragments/product-type.fragment.php'); ?>
