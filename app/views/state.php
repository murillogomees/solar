...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Estados - ". site_settings("site_name")) ?></title>
    ...
    <body>
        ...
        <?php
            $TopBar = new stdClass;
            $TopBar->title = __("Estados");
            $TopBar->btn = array(
                "icon" => "sli sli-layers",
                "title" => __("Adicionar novo Estado"),
                "link" => APPURL."/states/new"
        ...
        <?php require_once(APPPATH.'/views/fragments/state.fragment.php'); ?>
