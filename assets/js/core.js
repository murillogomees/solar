...
function autosave() {
	...
	if (idNew == "new" || Rascunho == true) {
        ...
        preco_total_sem_comissao: $("#precoTOTALsemComissao").val(),
        margemLucroProdutoReal: $("#margemRealProdutos").val(),
				kwpReal: $(".kwpReal").val(),
				comissao: $(".comissao").val(),
        comissaoLiquida: $("#precoTotalComissao").val(),
		...
		$.ajax({
			...
			success: function(resp) {
					console.log(resp);
        					 	 	...
        					 	 	var $pagamento = $("#pagamento").empty();
								 $pagamento.append($("<option selected disabled></option>")
											 .attr("value", '').text("Selecione "));
						 $.each(resp.pagamento, function( indexC, valueC ) {
									
											$pagamento.append($("<option  ></option>")
...
$("#statusOrcamento").on("change",  function() {
		var url = document.baseURI;
		var id = $(this).val();
    var id_orcamento = url.substring(url.lastIndexOf("/")+1,url.length);

    console.log(window.origin +"/orders");
  if(id == 3){
      Swal.fire({
        title: 'Porque deseja reprovar o orçamento? Conte em detalhes abaixo',
        input: 'text',
        inputAttributes: {
        autocapitalize: 'off'
        },
        ...
        preConfirm: (input) => {
            ...
            success: function(resp) {
              ...
              if (resp.result == 1) {
                Swal.fire({
                  position: 'top-end',
                  icon: 'success',
                  title: 'Orçamento reprovado com sucesso!',
      	...
      	$("#pUnitario").attr('hidden', false);
      	$("#pTotal").attr('hidden', false);
        $(".hiddenOUT").attr('hidden', false);
          ...
          $.ajax({
              ...
              success: function(resp) {
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Orçamento Aprovado com sucesso, confira abaixo os preços unitarios!',
                    showConfirmButton: false,
                    timer: 2500
                  })
	...
	$("body").on("change", ".changeTC", function() {
		...
		if (id == 2) {
          ...
          colsCT += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsCT += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsCT += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsCT += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					colsCT += '<td>';
					colsCT += '<a onchange="autosave()" class="erase-line" onclick="javascript:valorTotal(this)" href="javascript:void(0)"><span class="mdi mdi-eraser" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:#163145;"></span></a>' + '<a class="remove-line" href="javascript:void(0)"><span class="mdi mdi-close" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:red;"></span></a></td>';
					colsCT += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsCT += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsCT += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsCT += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsCT += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
	...
	$("body").on("change", ".changeAcoplador", function() {
		...
		if (fases >= 2 && Kwp >= '15' && tensao < 3) {
          ...
          colsAcoplador += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsAcoplador += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsAcoplador += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsAcoplador += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsAcoplador += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsAcoplador += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsAcoplador += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsAcoplador += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsAcoplador += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
	...
	$("body").on("change", ".changeFase", function() {
        ...
        if ($(".type-order").val() == "Unidade") {
          ...
          colsGetway += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsGetway += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsGetway += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsGetway += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsGetway += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsGetway += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsGetway += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsGetway += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsGetway += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
	...
	$("body").on("change", ".changeConsidera", function() {
		...
		if (id == 2) {
          ...
          colsCaboQ += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsCaboQ += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsCaboQ += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsCaboQ += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsCaboQ += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsCaboQ += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsCaboQ += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsCaboQ += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsCaboQ += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
          ...
          colsConectorFemea += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsConectorFemea += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsConectorFemea += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsConectorFemea += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsConectorFemea += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsConectorFemea += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsConectorFemea += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsConectorFemea += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsConectorFemea += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
          ...
          colsConectorMacho += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsConectorMacho += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsConectorMacho += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsConectorMacho += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsConectorMacho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsConectorMacho += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsConectorMacho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsConectorMacho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsConectorMacho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
...
// 		} 
    if (fabricante != "ENPHASE") {
          ...
          //if(typeOrder == "1"){
					...
					// TD PAINEL
					colsKit += '<td><select onchange="caboKwp()"  onchange="autosave()"  class="SelecPainel autosave select-table selectProduct calcPrice selectKitProd" onchange="javascript:valorTotal(this)" id="Painel" style="width:100%"><option value="0" selected hidden>Painel</option>';
					colsKit += '</select></td>';
          ...
          colsKit += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
          colsKit += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
          
					colsKit += '<td type="hidden" hidden><input  onchange="autosave()"  type="hidden" class="input-table-order row-total priceLiq" readonly></td>';
					colsKit += '<td hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					if ($(".type-order").val() == "Unidade") {
          colsKit += '<td>';
					colsKit += '<a onchange="autosave()" class="erase-line" onclick="javascript:valorTotal(this)" href="javascript:void(0)"><span class="mdi mdi-eraser" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:#163145;"></span></a>' + '<a class="remove-line" href="javascript:void(0)"><span class="mdi mdi-close" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:red;"></span></a></td>';
          }else{
					colsKit += '<td></td>';
          }
					colsKit += '<td hidden ><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsKit += '<td hidden > <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsKit += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsKit += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsKit += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
       ...
       //    } 
					...
					//TD INVERSOR
					colsInversor += '<td><select onchange="autosave()" onchange="calcPrice()" class="autosave select-table selectProduct calcPrice selectKitProd" onchange="javascript:valorTotal(this)" id="Inversor" style="width:100%"><option value="" selected hidden>Inversor</option>';
					...
					colsInversor += '<td><input onchange="autosave()" class="input-table-order calcPrice" onchange="javascript:valorTotal(this)"></td>';
				  	...
				  	colsInversor += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsInversor += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsInversor += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
          
					colsInversor += '<td hidden><input onchange="autosave()" type="hidden" class="input-table-order row-total priceLiq" readonly></td>';
				  colsInversor += '<td hidden><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					colsInversor += '<td>';
					colsInversor += '<a onchange="autosave()" class="erase-line" onclick="javascript:valorTotal(this)" href="javascript:void(0)"><span class="mdi mdi-eraser" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:#163145;"></span></a>' + '<a class="remove-line" href="javascript:void(0)"><span class="mdi mdi-close" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:red;"></span></a></td>';
          
          
          colsInversor += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsInversor += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsInversor += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsInversor += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsInversor += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';

					//TD String
					colsString += '<td><select onchange="autosave()" class="stringbox autosave select-table selectProduct calcPrice selectKitProd" onchange="javascript:valorTotal(this)" id="StringBox" style="width:100%"><option value="0" selected hidden>String Box</option>';
				   ...
				   if ($(".type-order").val() == "Unidade") {
				  	...
				  	colsString += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsString += '<td hidden  class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsString += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
          ...
          colsString += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsString += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsString += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsString += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsString += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
					...
					colsTrilho += '<td ><input onchange="autosave()" class="input-table-order calcPrice" onchange="javascript:valorTotal(this)"></td>';
				  	...
				  	colsTrilho += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsTrilho += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsTrilho += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
				  ...
				  colsTrilho += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsTrilho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsTrilho += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsTrilho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsTrilho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsTrilho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
			  	  ...
			  	  if ($(".type-order").val() == "Unidade") {
				  	...
				  	colsCaboA += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsCaboA += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsCaboA += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
				  ...
				  colsCaboA += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsCaboA += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsCaboA += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsCaboA += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsCaboA += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsCaboA += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
				   ...
				   if ($(".type-order").val() == "Unidade") {
				  	...
				  	colsCaboB += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsCaboB += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsCaboB += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
				  ...
				  colsCaboB += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsCaboB += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsCaboB += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsCaboB += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsCaboB += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsCaboB += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
				   ...
				   if ($(".type-order").val() == "Unidade") {
				  	...
				  	colsConectores += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsConectores += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsConectores += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
				  ...
				  colsConectores += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsConectores += '<td hidden ><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsConectores += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsConectores += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsConectores += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsConectores += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
					...
					colsKitFix += '<td><input onchange="autosave()" class="input-table-order calcPrice" onchange="javascript:valorTotal(this)"></td>';
				  	...
				  	colsKitFix += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsKitFix += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsKitFix += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
				  ...
				  colsKitFix += '<td  hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					colsKitFix += '<td>';
					colsKitFix += '<a onchange="autosave()" class="erase-line" onclick="javascript:valorTotal(this)" href="javascript:void(0)"><span class="mdi mdi-eraser" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:#163145;"></span></a>' + '<a class="remove-line" href="javascript:void(0)"><span class="mdi mdi-close" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:red;"></span></a></td>                                                                                                                                                                                                                                 ';
					colsKitFix += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsKitFix += '<td  hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsKitFix += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsKitFix += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsKitFix += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
...
//}
          ...
          colsInversor += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
         	 ...
         	 if ($(".type-order").val() == "Unidade") {
					...
					colsParafuso += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsParafuso += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
					colsParafuso += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
				  ...
				  colsParafuso += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
					...
					colsParafuso += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsParafuso += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsParafuso += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsParafuso += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsParafuso += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
          ...
          colsTrilho += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
					...
					colsTerm += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }else{
          colsTerm += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
					colsTerm += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
          }
					...
					colsTerm += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					colsTerm += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
          colsTerm += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
          colsTerm += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
          colsTerm += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
          ...
          colsKitFix += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
            ...
            if ($(".type-order").val() == "Unidade") {
				  	...
				  	colsCaboPP += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }else{
            colsCaboPP += '<td hidden class="hiddenOUT" ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
				  	colsCaboPP += '<td hidden class="hiddenOUT" ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
            }
					  ...
					  colsCaboPP += '<td type="hidden" hidden ><input onchange="autosave()"  class="input-table-order margemTotal totalUnit" readonly></td>';
						...
						colsCaboPP += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
					  colsCaboPP += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
            colsCaboPP += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
            colsCaboPP += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
            colsCaboPP += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
 ...
 $(document).ready(function() {
   ...
   if($("#comissao").val() == 0){
      $("#comissao").attr("readonly", "true");
      $("#comissao").val(0);
      }
   
   var comissaoAC = $(".comissaoActive").val();
   console.log(comissaoAC);
   if(comissaoAC == 1){
     
    selectByText('.comissaoActive', 'Não');
       
    calcPrice();
			
    selectByText('.comissaoActive', 'Valor Cheio (R$)');
   	setTimeout(function() {
    calcPrice();
					}, 800);
      } else {
  ...
  if($("#vtotalTotal").val()  ==  "R$ 0,00" || $("#vtotalTotal").val()  ==  "0"){
    
    Swal.fire({
      icon: 'error',
      title: 'Oops...',
      text: 'Selecione um produto primeiro!',
      footer: '<a href="https://suporte.horus.com.br">Entrar em contato com Suporte</a>'
    })
	...
	$("body").on("change , click ", ".calcPrice", function() {
    ...
    var id_cliente = $("#cliente").find('option:selected').val();
      ...
      console.log("recalcula");
		...
		var QUANTIDADE = 	qntPainel;
			...
			var tensao = $("#tensao").val();
			var fases = $("#fases").val();
			var idUsuario = $(".seller").find('option:selected').data("id");
			...
			$.ajax({
				...
				data: {
					...
					fases: fases,
					idUsuario: idUsuario,
				  valorIPI: $("#valorIPI").val(),
					valorCustoTOTAL: $("#TotalCusto").val(),
		...
		if (resp.kwpReal != 0) {
					...
					linha.find('td:nth-child(4)').find('input').val(resp.value.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					linha.find('td:nth-child(5)').find('input').val(valorTotal.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					linha.find('td:nth-child(6)').find('input').val(resp.precototalsemjuros.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					linha.find('td:nth-child(7)').find('input').val(resp.margemProduto.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					linha.find('td:nth-child(9)').find('input').val(resp.valoIPI.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));

					linha.find('td:nth-child(10)').find('input').val(resp.valorCustoTotal.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
          linha.find('td:nth-child(11)').find('input').val(resp.valorComissaoLiquida.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
          linha.find('td:nth-child(12)').find('input').val(resp.preco_total_sem_comissao.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
          linha.find('td:nth-child(13)').find('input').val(resp.margem_produto_sem_comissao.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					var vunitTotal = 0;
					...
					var vmargemtotal = 0;
					var valorFinalCusto = 0;
					var vtotalTotalSemJuros = 0;
          var valorComissao = 0;
          var valor_sem_Comissao = 0;
          var margem_sem_comissao = 0;
					...
					$("#orderTable tr").each(function() {
						...
						//console.log(vtotalTotalSemJuros+ "  fsdf");
						...
						if ($(this).find("input.valorIPI").val() != null) {
							if ($(this).find("input.valorIPI").val()) {
								var valorIPI = $(this).find("input.valorIPI").val().replace(/[^0-9,]/g, "")
								valorIPI = valorIPI.replace(".", "");
								valorIPI = valorIPI.replace(",", ".");
								ValorFinalIPI += parseFloat(valorIPI);
							}
						}
						if ($(this).find("input.ValorCustoTotal").val() != null) {
							if ($(this).find("input.ValorCustoTotal").val()) {
								var custoTotal = $(this).find("input.ValorCustoTotal").val().replace(/[^0-9,]/g, "");
								custoTotal = custoTotal.replace(".", "");
								custoTotal = custoTotal.replace(",", ".");
								valorFinalCusto += parseFloat(custoTotal);
                
							}
						}
            
            if ($(this).find("input.precoComissao").val() != null) {
							if ($(this).find("input.precoComissao").val()) {
								var comissaoValor = $(this).find("input.precoComissao").val().replace(/[^0-9,]/g, "");
								comissaoValor = comissaoValor.replace(".", "");
								comissaoValor = comissaoValor.replace(",", ".");
								valorComissao += parseFloat(comissaoValor);
							}
						}
            if ($(this).find("input.precoSemComissao").val() != null) {
							if ($(this).find("input.precoSemComissao").val()) {
								var precoSemComissao = $(this).find("input.precoSemComissao").val().replace(/[^0-9,]/g, "");
								precoSemComissao = precoSemComissao.replace(".", "");
								precoSemComissao = precoSemComissao.replace(",", ".");
								valor_sem_Comissao += parseFloat(precoSemComissao);
							}
						}
            if ($(this).find("input.margemSemComissao").val() != null) {
							if ($(this).find("input.margemSemComissao").val()) {
								var margemSemComissao = $(this).find("input.margemSemComissao").val().replace(/[^0-9,]/g, "");
								margemSemComissao = margemSemComissao.replace(".", "");
								margemSemComissao = margemSemComissao.replace(",", ".");
								margem_sem_comissao += parseFloat(margemSemComissao);
							}
						}

					});
        
         $("#precoTOTALsemComissao").val(valor_sem_Comissao.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
        
          var valor_maximo_comissao = (parseFloat(valor_sem_Comissao.toFixed(2)) * 1.30) - valor_sem_Comissao.toFixed(2); 
          
          
          if($(".comissaoActive").val() == 1 && comissao != ""){
        
           var totalPedido = parseFloat(valor_sem_Comissao.toFixed(2)) + parseFloat(comissao);
          } else {
           var totalPedido = parseFloat(valor_sem_Comissao.toFixed(2));
          }
          
          var margemComissao = comissao / valor_sem_Comissao;
          var margem_comissao = (margemComissao * 100);

          console.log(margemComissao);
          if((margemComissao.toFixed(2) > 0.30 && resp.nivel == "diretoria" ) || (margemComissao.toFixed(2) > 0.30 &&  resp.nivel == "admin") ){

             } else if(margemComissao.toFixed(2) > 0.30) {
              Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Seu valor de comissão ultrapassa a margem permitida de 30%, margem atual de '+ margem_comissao.toFixed(2)  +"%. " + "Preço ajustado para R$: " + valor_maximo_comissao.toFixed(2) ,
                footer: 'Horus S/A'
              })
               $("#comissao").val(valor_maximo_comissao.toFixed(2)); 
               calcPrice();
               return false;
             }
       
          $("#precoTotalComissao").val(valorComissao.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
          
          $("#isv").val(resp.nivel);
					$("#vtotalPriceSemJuros").val(vtotalTotalSemJuros.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));

				
					$("#TotalCusto").val(valorFinalCusto.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					
					$("#valorIPI").val(ValorFinalIPI.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					
					$("#vuntTotal").val(vunitTotal.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					
					$("#vmargemTotal").val(vmargemtotal.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
					$("#vtotalTotal").val(totalPedido.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
       
          
          var margemProdutos = (margem_sem_comissao / valor_sem_Comissao) * 100 ;
          $("#margemRealProdutos").val(margemProdutos.toFixed(2) + "%");

					var margemCampo2 = (vmargemtotal / totalPedido) * 100;
					...
					var margemReal1 = parseFloat(margemCampo2);


					var margemReal = margemReal1;
...
// 	});
   ...
   var valorTOTAL =  $("#vtotalTotal").val();
   var comissaoC =  $("#comissao").val();
   var isv =  $("#isv").val();
    
    
    
    
    var vtotalTotal = valorTOTAL.replace(/\D/g, '') / 100;
    var comissao =   comissaoC.replace(/\D/g, '') ;
//     var margemComissao = comissao / vtotalTotal;
//     var margem_comissao = (margemComissao * 100);

    console.log($("#pagamento").val());
    ...
    if($("#pagamento").val() == null ){
          Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Verifique se o campo [Condição de Pagamento] esta preenchido!',
                footer: 'Horus S/A'
              })
               return false;
             }
      ...
      var total_sem_comissao =  $("#precoTOTALsemComissao").val(); 
      var total_sem_comissao2 =   total_sem_comissao.replace(/\D/g, '') ;
      var valorTOTALsemCOMISSAO = total_sem_comissao2 / 100;
      var margemComissao = parseFloat(comissao) / parseFloat(valorTOTALsemCOMISSAO);
      var margem_comissao = (margemComissao);
    
    
      var valor_maximo_comissao = (parseFloat(valorTOTALsemCOMISSAO.toFixed(2)) * 1.30) - parseFloat(valorTOTALsemCOMISSAO.toFixed(2)); 
          
          
          if($(".comissaoActive").val() == 1 && comissao != ""){
        
           var totalPedido = parseFloat(valorTOTALsemCOMISSAO.toFixed(2)) + parseFloat(comissao);
          } else {
           var totalPedido = parseFloat(valorTOTALsemCOMISSAO.toFixed(2));
          }
          
      

    console.log(margemComissao.toFixed(2) + "   sddsfsfds");
          console.log(margemComissao);
          if((margem_comissao.toFixed(2) > 30.0 && isv == "diretoria" ) || (margem_comissao.toFixed(2) > 30.0 &&  isv == "admin") ){

             } else if(margem_comissao.toFixed(2) > 30.0 ) {
              Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Seu valor de comissão ultrapassa a margem permitida de 30%, margem atual de '+ margem_comissao.toFixed(2)  +"%. " + "Preço ajustado para R$: " + valor_maximo_comissao.toFixed(2) ,
		...
		// 				if($(".paymentMode").val() == null || $(".ufFrete").val() == null || $(".type-order").val() || $(".uf-branch").val() == null ){
		// 			toastr.warning('Verifique se todos os campos obrigatórios foram preenchidos!');
		// 			return false;
		...
		$form.find(".selectProduct").each(function() {
			...
			if (id != "0" && $(this).parent().parent().find('td:nth-child(3)').find('input').val() != "") {
				p.id = id;
				p.product = name;
				p.quantidade = $(this).parent().parent().find('td:nth-child(3)').find('input').val();
				p.price = $(this).parent().parent().find('td:nth-child(4)').find('input').val();
...
// 			}
   ...
   if(($(".type-order").val() == 1 && $(".SelecPainel").val() ==  undefined) || ($(".type-order").val() == 1 && (($(".SelecPainel").val() == 0 && $("#StringBox").val() == 0) || ($(".SelecPainel").val() != 0 && $("#StringBox").val() == 0 )) && $("#fabricanteInversor").val() != "ENPHASE") ){
      		Swal.fire({
              icon: 'error',
              title: 'Oops...',
              text: 'Para orçamentos de Kit é obrigatório a inclusão de Painel Fotovoltaico e StringBox!',
              footer: '<a href="https://suporte.horus.com.br">Entrar em contato com Suporte</a>'
            })
    
      return false;
       } else if(($(".type-order").val() == 1 && $(".SelecPainel").val() ==  undefined) || ($(".type-order").val() == 1 && $(".SelecPainel").val() == 0 )){
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Para orçamentos de Kit é obrigatório a inclusão de Painel Fotovoltaico!',
            footer: '<a href="https://suporte.horus.com.br">Entrar em contato com Suporte</a>'
          })
      return false;
     }
...
function valorTotal(value) {
	...
	$("#vtotalTotal").val(vtotalTotal.toLocaleString('pt-br', {
		style: 'currency',
		currency: 'BRL'
	}));
...
function AddTableRow(seconds) {
	...
	if ($(".type-order").val() == "Unidade") {
    cols += '<td ><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
    cols += '<td ><input   class="input-table-order unitTotal totalUnit" readonly></td>';
   } else {
    cols += '<td class="hiddenOUT" hidden><input onchange="autosave()" class="input-table-order unitPrice totalUnit" readonly></td>';
    cols += '<td class="hiddenOUT" hidden><input   class="input-table-order unitTotal totalUnit" readonly></td>';
    }
  
	cols += '<td type="hidden" hidden><input type="hidden" class="input-table-order row-total priceLiq" readonly></td>';
	cols += '<td hidden ><input class="input-table-order margemTotal totalUnit" readonly></td>';
	cols += '<td>';
	cols += '<a class="erase-line" onclick="javascript:valorTotal(this)" href="javascript:void(0)"><span class="mdi mdi-eraser" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:#163145;"></span></a>' + '<a class="remove-line" href="javascript:void(0)"><span class="mdi mdi-close" style="font-size: 25px;padding: 2px;position: relative;top:3px;color:red;"></span></a>';
	cols += '</td>';
  cols += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total valorIPI" value="" readonly></td>';
  cols += '<td hidden> <input  onchange="autosave()"   class="input-table-order row-total ValorCustoTotal" value="" readonly></td> ';
  cols += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoComissao" value="0" readonly></td> ';
  cols += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total precoSemComissao" value="0" readonly> </td>';
  cols += '<td hidden><input  onchange="autosave()"   class="input-table-order row-total margemSemComissao" value="0" readonly></td>';
...
function calcPrice() {
	...
	$(".selectProduct").each(function() {
       ...
       console.log(valorComissao + " gffgfggfgffg");
          $("#precoTotalComissao").val(valorComissao.toLocaleString('pt-br', {
						style: 'currency',
						currency: 'BRL'
					}));
