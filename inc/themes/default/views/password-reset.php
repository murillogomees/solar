                ...
                <div class="signup side float-left flex flex-start flex-middle" data-active='open'>
                    <div class="signup-form">
                        <div class="form-holder">
                            <div class="title">
                                <h1 style="color:#212121"><?= __("Password Reset") ?></h1>
                            </div>
                                ...
                                <form action="<?= APPURL."/recovery/".$Route->params->id.".".$Route->params->hash ?>" method="POST" autocomplete="off">
                                    <?php if (empty($success)): ?>
                                        ...
                                        <div class="form-element">
                                            <div class="input-wrapper material-style">
                                                <input type="password" class="input-style" 
                                                       id="password-confirm"  name="password-confirm" placeholder="Confirmar senha">                                                
                                            </div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        <div class="recover-sent">
                                            <h2 style="color:#212121" class="title"><?= __('Success!') ?></h2>
                                            <p style="color:#212121"><?= __("You've successfully reset your password!") ?></p>
