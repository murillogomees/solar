...
<html class="no-js" lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <link rel="icon" href="<?= site_settings("logomark") ? site_settings("logomark") : APPURL."/assets/img/aluguel-icon-preto.png" ?>" type="image/x-icon">
        <link rel="shortcut icon" href="<?= site_settings("logomark") ? site_settings("logomark") : APPURL."/assets/img/aluguel-icon-preto.png" ?>" type="image/x-icon">
                ...
                <div class="signup side float-left flex flex-start flex-middle" data-active='open'>
                    <div class="signup-form">
                        <div class="form-holder">
                            <div class="title">
                                <h1 style="color:#212121"><?= __("Password Recovery") ?></h1>
                            </div>
                            <div class="form">
                                <form action="<?= APPURL."/recovery" ?>" method="POST" autocomplete="off">
                                        ...
                                        <div class="form-element">
                                            <div class="input-wrapper material-style">
                                                <input type="email" class="input-style" 
                                                       id="email"  name="email"
                                                       value="<?= htmlchars(Input::Post("email")) ?>" placeholder="Seu endereço de email">                                               
                                            </div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        <div class="recover-sent">
                                            <h2 style="color:#212121" class="title"><?= __('Email Sent!') ?></h2>
                                            <p style="color:#212121"><?= __('Password reset instruction sent to your email address.') ?></p>
                                        </div>
                                    <?php endif; ?>
                                </form>
                            </div>
